...
notes _race: Ensure the following race definitions are appropriate and the same for expected mortality calculations and merging: _race: 0 "White" 1 "Black" 2 "Other (American Indian/AK native, Asian/Pacific Islander)" 3 "Other Unspecified (1991+)" 4 "Unknown"
